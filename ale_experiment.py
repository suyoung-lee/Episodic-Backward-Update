...
class ALEExperiment(object):
    ...
    def run(self):
        ...
        for epoch in range(1, self.num_epochs + 1):
            ...
            if self.test_length>0:
                ...
                self.run_epoch(epoch, 4500, True) #4500 steps = 18000 frames = 5 min at most for an episode
    ...
    def run_epoch(self, epoch, num_steps, testing=False):
        ...
        if testing == False:
            ...
            while self.test_episode<30: # test score is average of 30 episodes
                prefix = "testing"
                """logging.info(prefix + "epoch: " + str(epoch) + " th episode" + str(self.test_episode))"""
                _, temp_steps = self.run_episode(num_steps,testing)
                self.test_episode +=1
